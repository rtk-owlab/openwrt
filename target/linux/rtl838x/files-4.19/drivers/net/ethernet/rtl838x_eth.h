...
#define RTL8380_TBL_ACCESS_CTRL_0		(RTL838X_SW_BASE + 0x6914)
#define RTL8380_TBL_ACCESS_DATA_0(idx)		(RTL838X_SW_BASE + 0x6918 + ((idx) << 2))
#define RTL8380_TBL_ACCESS_CTRL_1		(RTL838X_SW_BASE + 0xA4C8)
#define RTL8380_TBL_ACCESS_DATA_1(idx)		(RTL838X_SW_BASE + 0xA4CC + ((idx) << 2))
